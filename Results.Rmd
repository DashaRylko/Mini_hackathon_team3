...
tidy_model_age %>% 
  ...
  set_table_properties(layout= "autofit",width=.9)
```
Наблюдается статистически значимое снижение количества НЯ в группе пациентов, принимавших препарат 1 по сравнению с группой пациентов, принимавших Плацебо (снижение количества НЯ на 40%, 95% ДИ: 0.13 - 0.76), не обнаружено различий в частоте НЯ среди пациентов, принимавших препарат 2 и принимавших Плацебо.
...
#### Влияние качествнных признаков на количесвто НЯ
```{r}
